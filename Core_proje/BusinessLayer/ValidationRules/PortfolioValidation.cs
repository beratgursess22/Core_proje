...
namespace BusinessLayer.ValidationRules
{
    public class PortfolioValidation: AbstractValidator<Portfolio>
    {
        public PortfolioValidation()
        {
            ...
            RuleFor(x => x.Name).NotEmpty().WithMessage("Proje adı en az 5 karakterden oluşmak zorundadır");
            RuleFor(x => x.Name).NotEmpty().WithMessage("Proje adı en fazla 100 karakterden oluşmak zorundadır");
